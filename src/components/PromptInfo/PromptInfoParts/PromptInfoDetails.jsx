...
const PromptInfoDetails = ({ product, onFavoriteChange, productId, profileId }) => {
            ...
            <div className="prompt__info-head">
                ...
                <div className="prompt__head-tools">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" className="heart__img" onClick={handleFavoriteClick}
                         style={isFavorite ? {stroke: 'red' } : {stroke: 'white'}}>
                        <path
